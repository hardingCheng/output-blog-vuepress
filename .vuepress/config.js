module.exports = {
  title: "前端学习总结和技巧",
  description: "一个前端的学习小白，站在前端大佬们的肩膀上前行",
  dest: "public",
  head: [
    [
      "link",
    ...
    [
      ...
      {
        name: "keywords",
        content: "前端,前端教程,免费前端学习,前端面经,前端知识点,前端知识体系",
      },
    ],
    [
      "meta",
      {
        name: "decription",
        content:
          "自我总结前端总结,最全的前端知识点,坚持的刷题路线,完善的学习经验和体系",
      },
    ],
    [
      "meta",
      ...
      "/blogs/Interview/HandwrittenCode/": [
        {
          title: "手写代码",
          collapsable: true,
          children: ["/blogs/Interview/HandwrittenCode"],
        },
      ],
    },
    subSidebar: "auto",
